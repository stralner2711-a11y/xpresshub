...
assert(app.includes("const APP_DISPLAY_VERSION = '1.3.4'"), 'App should expose human APK version');
assert(app.includes('const APP_VERSION_CODE = 17'), 'App should compare numeric Android version codes');
...
assert(version.activeVersion === '1.3.4', 'version.json should expose activeVersion');
assert(version.activeVersionCode === 17, 'version.json should expose activeVersionCode');
