...
assert(app.includes("const APP_DISPLAY_VERSION = '1.2.4'"), 'App should expose human APK version');
assert(app.includes('const APP_VERSION_CODE = 7'), 'App should compare numeric Android version codes');
...
assert(version.activeVersion === '1.2.4', 'version.json should expose activeVersion');
assert(version.activeVersionCode === 7, 'version.json should expose activeVersionCode');
