...
assert(app.includes("const APP_DISPLAY_VERSION = '1.2.9'"), 'App should expose human APK version');
assert(app.includes('const APP_VERSION_CODE = 12'), 'App should compare numeric Android version codes');
...
assert(version.activeVersion === '1.2.9', 'version.json should expose activeVersion');
assert(version.activeVersionCode === 12, 'version.json should expose activeVersionCode');
