...
assert(app.includes("const APP_DISPLAY_VERSION = '1.2.7'"), 'App should expose human APK version');
assert(app.includes('const APP_VERSION_CODE = 10'), 'App should compare numeric Android version codes');
...
assert(version.activeVersion === '1.2.7', 'version.json should expose activeVersion');
assert(version.activeVersionCode === 10, 'version.json should expose activeVersionCode');
