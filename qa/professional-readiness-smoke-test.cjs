...
assert(source.includes("CACHE_NAME = 'xpressintra-v71-invite-only-signup'"), 'Service worker cache version should be bumped');
...
assert(app.includes("const APP_VERSION = '1.3.10-release-v71'"), 'App version should be visible in code');
assert(app.includes("const APP_DISPLAY_VERSION = '1.3.10'"), 'APK display version should be visible in code');
assert(app.includes('const APP_VERSION_CODE = 23'), 'APK version code should be visible in code');
