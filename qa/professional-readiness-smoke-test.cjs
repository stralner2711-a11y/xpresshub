...
assert(source.includes("CACHE_NAME = 'xpressintra-v69-creator-rollback'"), 'Service worker cache version should be bumped');
...
assert(app.includes("const APP_VERSION = '1.3.8-release-v69'"), 'App version should be visible in code');
assert(app.includes("const APP_DISPLAY_VERSION = '1.3.8'"), 'APK display version should be visible in code');
assert(app.includes('const APP_VERSION_CODE = 21'), 'APK version code should be visible in code');
