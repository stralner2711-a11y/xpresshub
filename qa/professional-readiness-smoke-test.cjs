...
assert(source.includes("CACHE_NAME = 'xpressintra-v73-employee-delete-restore'"), 'Service worker cache version should be bumped');
...
assert(app.includes("const APP_VERSION = '1.3.12-release-v73'"), 'App version should be visible in code');
assert(app.includes("const APP_DISPLAY_VERSION = '1.3.12'"), 'APK display version should be visible in code');
assert(app.includes('const APP_VERSION_CODE = 25'), 'APK version code should be visible in code');
