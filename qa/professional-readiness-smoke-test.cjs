...
for (const source of [worker, rootWorker]) {
  assert(source.includes("CACHE_NAME = 'xpressintra-v53-danish-splash'"), 'Service worker cache version should be bumped');
...
assert(app.includes("const APP_VERSION = '0.3.0-test-v53'"), 'App version should be visible in code');
