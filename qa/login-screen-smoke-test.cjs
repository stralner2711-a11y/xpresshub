...
assert(app.includes('Standardkoden bruges kun via "Opret konto med standardkode"'), 'Login should show a friendly message when xpress is used on the wrong button');
