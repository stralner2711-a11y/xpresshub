...
harness.run("workday = { ...workday, active: true, endsAt: '2026-05-31T18:59:00.000+02:00' }; location = { ...location, sharing: true, timer: 2 }; save('workday', workday); enforceWorkdayExpiry(new Date('2026-05-31T19:01:00.000+02:00'));");
